...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        ImGui::TextWrapped(
            ...
            "Hover the texture for a zoomed view2!");
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                // From a user point of view2 we will tend to use 'inner_width' differently depending on whether our table is embedding scrolling.
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            ImGui::BeginGroup();
            ImGui::BeginChild("item view2", ImVec2(0, -ImGui::GetFrameHeightWithSpacing())); // Leave room for 1 line below us
