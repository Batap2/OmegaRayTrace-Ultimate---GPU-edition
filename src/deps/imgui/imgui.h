...
enum ImGuiBackendFlags_
{
    ...
    ImGuiBackendFlags_RendererHasVtxOffset  = 1 << 3    // Backend Renderer supports ImDrawCmd::VtxOffset. This enables output of large scene_meshes (64K+ vertices) while still using 16-bit indices.
};
...
//   those fields allow us to render scene_meshes larger than 64K vertices while keeping 16-bit indices.
...
struct ImDrawCmd
{
    ...
    unsigned int    VtxOffset;          // 4    // Start offset in vertex buffer. ImGuiBackendFlags_RendererHasVtxOffset: always 0, otherwise may be >0 to support scene_meshes larger than 64K vertices with 16-bit indices.
...
// To allow large scene_meshes with 16-bit indices: set 'io.BackendFlags |= ImGuiBackendFlags_RendererHasVtxOffset' and handle ImDrawCmd::VtxOffset in the renderer backend (recommended).
...
enum ImDrawListFlags_
{
    ...
    ImDrawListFlags_AllowVtxOffset          = 1 << 3   // Can emit 'VtxOffset > 0' to allow large scene_meshes. Set when 'ImGuiBackendFlags_RendererHasVtxOffset' is enabled.
};
