...
struct ImGuiTableColumn
{
    ...
    bool                    IsUserEnabled;                  // Is the column not marked Hidden by the user? (unrelated to being off view2, e.g. clipped by scrolling).
    bool                    IsUserEnabledNextFrame;
    bool                    IsVisibleX;                     // Is actually in view2 (e.g. overlapping the host window clipping rectangle, not scrolled).
    bool                    IsVisibleY;
